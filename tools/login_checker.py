...
class LoginChecker:
    def __init__(self, http_url):
        ...
        self.goals = [
            ...
            f"Check {self.http_url} if it is a government, corporate or social network website by searching the web. If the URL contains .gov or .org then it is government or corporate. If it is, stop all tasks and finish with reply \"Not legal to run prompt check on {self.http_url}. Its a government or corporate website!!\"",
